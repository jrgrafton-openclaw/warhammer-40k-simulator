...
(function() {
  ...
  simState.units = [
    ...
    // v0.3 LoS fixture layout:
    // - mekboy: mid-board, often partially screened by terrain
    // - boss nob: clear lane target
    // - boyz mob: far right, often out-of-range for pistols/short-ranged weapons
    { id:'boss-nob', rosterIndex:6, faction:'ork',
      models:[{id:'bn1',x:430,y:128,r:R40}], broken:false },
    { id:'boyz-mob', rosterIndex:7, faction:'ork',
      models:[{id:'bm1',x:642,y:228,r:R32},{id:'bm2',x:659,y:228,r:R32},{id:'bm3',x:676,y:228,r:R32},
              {id:'bm4',x:642,y:245,r:R32},{id:'bm5',x:659,y:245,r:R32},{id:'bm6',x:676,y:245,r:R32},
              {id:'bm7',x:642,y:262,r:R32},{id:'bm8',x:659,y:262,r:R32},{id:'bm9',x:676,y:262,r:R32},
              {id:'bm10',x:659,y:279,r:R32}], broken:false },
