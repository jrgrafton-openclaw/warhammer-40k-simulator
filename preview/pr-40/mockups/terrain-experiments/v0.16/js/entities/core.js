...
Editor.Core = {
  ...
  populateThumbs() {
    const thumbs = {
      ...
      tScatter: ['scatter-layer.png','scatter-v2.png','scatter-v3.png','scatter-v4.png','scatter-v5.png','scatter-v6.png','openai-scatter.png','rubble-edge-1.png','rubble-edge-2.png','rubble-edge-3.png','rubble-edge-4.png','scatter-vehicle-leman-russ.png','scatter-vehicle-rhino.png','scatter-vehicle-dreadnought.png','scatter-vehicle-chimera.png','scatter-vehicle-predator.png','scatter-ork-trukk.png','scatter-tau-devilfish.png','scatter-eldar-wave-serpent.png','scatter-necron-ghost-ark.png','scatter-chaos-rhino.png','scatter-dead-marine.png','scatter-dead-ork-pile.png','scatter-dead-tau-firewarrior.png','scatter-dead-tyranid.png','scatter-dead-guardsmen-pile.png']
    };
