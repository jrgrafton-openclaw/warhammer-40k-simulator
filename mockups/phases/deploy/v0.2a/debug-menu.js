...
(function initDebugMenu() {
  ...
  function applyZoneVignettes() {
    ...
    var opacity = state.zoneVigOpacity != null ? state.zoneVigOpacity : 0.25;
    window.__zoneVigActiveOpacity = state.zoneVigActiveOpacity != null ? state.zoneVigActiveOpacity : 0.55;
