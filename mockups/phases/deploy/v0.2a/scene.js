...
(function addSvgBoardSurface() {
  ...
  zoneVigInfo.forEach(function(zi) {
    // Create 4 linear gradients (L/R/T/B) for this zone
    var dirs = [
    ...
    dirs.forEach(function(d) {
      ...
      lg.innerHTML =
        ...
        '<stop offset="40%" stop-color="rgb(' + zi.color + ')" stop-opacity="0.15"/>' +
    ...
    sides.forEach(function(s) {
      ...
      vigSvg.appendChild(r);  // Outside the noise-filtered group — clean edges
    });
  });
